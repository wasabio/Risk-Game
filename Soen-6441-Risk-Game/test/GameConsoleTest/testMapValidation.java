...
/**
 * test if the map valid when there is no country or continent in a map
 * @author Yueshuai
 *
 */
public class testMapValidation {
	...
	/* test when there are c at least 1 continent and 1 country in the map and player number less than
	 * country number */
	@Test
